...
$$ p_{cr}=40 \: N=45 \: q=1 $$
$$ \tau_1=25 \: \tau_2=20 $$
$$ \widetilde{p}_1=8 \: \widetilde{p}_2=8.5 $$
...
![График конкуренции двух фирм фирм для первого случая, построенный на языке Julia](image/lab8_julia_1.PNG){ #fig:001 width=70% height=70% }

![График конкуренции двух фирм для второго случая, построенный на языке Julia](image/lab8_julia_2.PNG){ #fig:002 width=70% height=70% }
...
![График конкуренции двух фирм для первого случая, построенный с помощью OpenModelica](image/lab8_openmodelica_1.PNG){ #fig:004 width=70% height=70% }

![График конкуренции двух фирм для второго случая, построенный с помощью OpenModelica](image/lab8_openmodelica_2.PNG){ #fig:005 width=70% height=70% }
