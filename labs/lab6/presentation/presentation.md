...
!["График, построенный на языке Julia"](image/lab6_julia_1.png){#fig:001}

::: 
::: {.column width="50%"}

!["График, построенный на языке Open Modelica"](image/lab6_opmod_1.png){#fig:003}
...
!["График, построенный на языке Julia"](image/lab6_julia_2.png){#fig:002}

::: 
::: {.column width="50%"}

!["График, построенный на языке Open Modelica"](image/lab6_opmod_2.png){#fig:004}
